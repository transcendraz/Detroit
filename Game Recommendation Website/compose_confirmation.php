...
if ( !isset($_POST['game']) || empty($_POST['game']) 
	...
	$sql = "INSERT INTO Comment (game, stars, publish, comment, price, img, user_id, platform_id)
                    VALUES ('" 
					. $_POST['game'] 
					. "', "
					. $_POST['stars']
...
<head>
	...
	<title>Compose Confirmation</title>
...
<body>
	...
	<div class="container">
			...
			<div class="col-12">
				...
				<?php else: ?>
					<div class="text-success">
						<span class="font-italic"><?php echo $_SESSION['username']?></span>'s review regarding "<?php ECHO $_POST['game']?>" was successfully added.
					</div>
				<?php endif; ?>
			</div> <!-- .col -->
		</div> <!-- .row -->
		<div class="row mt-4 mb-4">
			<div class="col-12">
				<a href="compose.php" role="button" class="btn btn-dark">Back to Compose</a>
			</div> <!-- .col -->
		</div> <!-- .row -->
    </div> <!-- .container -->
