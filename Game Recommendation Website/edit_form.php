...
$sql_comment = "SELECT * 
							FROM Comment 
							WHERE idComment = " . $_GET['comment_id'] . ";";
$results_comment = $mysqli->query($sql_comment);
if ( $results_comment == false ) {
	echo $mysqli->error;
	exit();
}

$row_comment = $results_comment->fetch_assoc();
...
<head>
    ...
    <link rel="stylesheet" href="overall.css"><style>
        body{
			font-family: fantasy;
		}
		.jumbotron {
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
                ...
                <form id="mainform" action="edit_confirmation.php" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="game-id" name="game" value="<?php echo $row_comment['game']; ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="publish-date-id" name="publish_date" value="<?php echo $row_comment['publish']; ?>">
                        </div>
                    </div> <!-- .form-group -->
                        ...
                        <div class="col-sm-9">
                            <select name="platform" id="platform-id" class="form-control">
								...
								<?php while($row = $results_platform->fetch_assoc()) : ?>
									...
									<?php if ( $row['idPlatform'] == $row_comment['platform_id'] ) : ?>

										<option selected value= "<?php echo $row['idPlatform']; ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="stars" id="stars-id" class="form-control">
								...
								<?php if($row_comment['stars']==1):?>
									<option selected value="<?php echo $row_comment['stars']?>"><?php echo $row_comment['stars']?></option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
									<option value="5">5</option>
								<?php elseif($row_comment['stars']==2):?>
									<option value="1">1</option>
									<option selected value="<?php echo $row_comment['stars']?>"><?php echo $row_comment['stars']?></option>
									<option value="3">3</option>
									<option value="4">4</option>
									<option value="5">5</option>
								<?php elseif($row_comment['stars']==3):?>
									<option value="1">1</option>
									<option value="2">2</option>
									<option selected value="<?php echo $row_comment['stars']?>"><?php echo $row_comment['stars']?></option>
									<option value="4">4</option>
									<option value="5">5</option>
								<?php elseif($row_comment['stars']==4):?>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option selected value="<?php echo $row_comment['stars']?>"><?php echo $row_comment['stars']?></option>
									<option value="5">5</option>
								<?php elseif($row_comment['stars']==5):?>
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="price-id" name="price" min="-1" value="<?php echo $row_comment['price']; ?>">
                        </div>
                    </div> <!-- .form-group -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="image-id" name="ImageUrl" value="<?php echo $row_comment['img']; ?>">
                        </div>
                    </div> <!-- .form-group -->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="comment" id="comment-id" class="form-control"><?php echo $row_comment['game']; ?></textarea>
                        </div>
                    </div> <!-- .form-group -->
